...
parser.add_argument('--model', default='T0628-1910-Caption2-Lstop3-Lword1-Lcla3', type=str, help="get center type")
...
weightname = os.path.join(path, '..', Flags.model, 'Model', 'Model_Ep40_BLEU_0.5206.pkl')
...
pred_dir = os.path.join(path, '..', Flags.model, 'Result', Flags.model+'ImageCaption.csv')
