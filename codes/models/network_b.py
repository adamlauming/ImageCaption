...
#===================================================================================
# caption models - 2 hierarchical RNN !!!
#===================================================================================
class Caption2(nn.Module):
    ...
    def forward(self, x1, x2, context):
        ...
        # h_init_prev = h_init.permute(1, 0, 2)
        # prev_hidden_states[:,0,:] = h_init_prev[:,0,:]
        # sentence_states = (h_init, c_init)
